...
export const CURATED_ABILITY_UI: Record<string, CuratedAbilityUiMetadata> = {
  ...
  deadshot: {
    ...
    detailLines: [
      '105%-125% ranged damage per hit.',
      '4-hit single-target ultimate.',
      'Damage is 60% effective in PvP.',
    ],
  ...
  'greater-ricochet': {
    ...
    detailLines: [
      '75%-85% ranged damage to the target and up to 6 nearby enemies.',
      'Missing bounces convert into extra damage on the main target.',
      'Pairs with Caroming.',
    ],
  ...
  'piercing-shot': {
    ...
    hoverSummary: 'Basic | 3 ticks | 2 hits | +9% adrenaline',
    detailLines: [
  ...
  ricochet: {
    ...
    hoverSummary: 'Basic | 17 ticks | 1 hit | +9% adrenaline',
    detailLines: [
      '75%-85% ranged damage to the target and up to 2 nearby enemies.',
      'Missing bounces convert into extra damage on the main target.',
      'Pairs with Caroming.',
    ],
