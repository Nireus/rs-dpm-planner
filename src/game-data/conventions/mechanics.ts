...
export const CONFIG_OPTION_IDS = {
  ...
  channellersRingMetaphysicsEnchanted: 'channellers-ring-metaphysics-enchanted',
  enhancedGlovesOfPassageAgonyEnchanted: 'enhanced-gloves-of-passage-agony-enchanted',
} as const;
...
export const EFFECT_REF_IDS = {
  ...
  nodonSpikeHarnessPassive: 'karmic-retribution',
  ...
  weaponSpecialRampage: 'weapon-special:rampage',
...
const EXACT_EFFECT_REFS = new Set<string>([
  ...
  'binding-shot-bind',
  'blessing-of-het',
  'channellers-ring-runic-embrace',
  'corruption-shot',
  'dazing-shot',
  'deathspore-cooldown',
  ...
  'malevolence',
  'needle-strike-buff',
  EFFECT_REF_IDS.nodonSpikeHarnessPassive,
